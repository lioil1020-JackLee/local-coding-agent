# Project Structure
  ...
  │   │   ├── agent_session_runtime.py                   252 lines  
  │   │   ├── agent_session_state_service.py              71 lines  
  │   │   ├── cli_agent_service.py                       167 lines  
  ...
  └── tests  
      ...
      ├── test_agent_session_runtime.py                   59 lines  
      ...
      ├── test_cli_chat_mode.py                           49 lines  
